...
def translate_to_persian(text):
    ...
    return translations.get(text.lower(), "ترجمه‌ای پیدا نشد.")
...
def show_image():
    ...
    if image_url:
        ...
        try:
          ...
          text_box.delete(1.0, tk.END)
          text_box.insert(tk.END,"تصویری پیدا نشد.")
...
root = tk.Tk()
root.title("جستجوی تصویر حیوانات")

button=tk.Button(root,text="نشان دادن تصویر",command=show_image)
button.pack(pady=10)
